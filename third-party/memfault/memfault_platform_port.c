...
size_t memfault_platform_sanitize_address_range(void *start_addr,
  ...
  struct {
    ...
    size_t length;
      ...
      {.start_addr = (uint32_t)&__base_RAM, .length = (uint32_t)&__top_RAM - (uint32_t)&__base_RAM},
  // [ 3] .data             PROGBITS        20000000 020000 0001e8 00  WA  0   0  4
  // [ 8] .bss              NOBITS          200001e8 0001e8 00302c 00  WA  0   0  8
  // [16] .noinit           NOBITS          20003214 0001e8 000440 00  WA  0   0  4
  // [17] .heap             NOBITS          20003654 0001e8 001000 00  WA  0   0  4
  // [18] .heap2stackfill   NOBITS          20004654 0001e8 001000 00  WA  0   0  1

  // __base_RAM = 0x20000000 ; /* RAM */
  // __top_SRAM_DTC = 0x20000000 + 0x10000 ; /* 64K bytes */
...
// MEMFAULT_PUT_IN_SECTION(".noinit.$RAM3.mflt_reboot_tracking")
